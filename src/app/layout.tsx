...
.taskCard,.submissionItem,.feedbackBox,.taskPicker{border:1px solid var(--line);border-radius:8px;background:#fbfcfe}.taskCard{display:grid;gap:12px;padding:16px}.taskActions{display:flex;align-items:center;flex-wrap:wrap;gap:10px;justify-content:flex-end}.taskActions .button{min-height:44px}.inlineForm{display:grid;grid-template-columns:minmax(180px,1fr) auto;gap:12px;align-items:end;padding:12px;border:1px solid var(--line);border-radius:8px;background:#fff}.statusPill{display:inline-flex;align-items:center;width:fit-content;min-height:28px;margin-top:8px;border:1px solid var(--line);border-radius:999px;padding:0 10px;color:var(--muted);background:#fff;font-size:13px;font-weight:800}.statusACTIVE{border-color:rgba(31,157,119,.28);color:var(--green);background:#eaf8f3}.statusCLOSED{border-color:rgba(101,117,139,.26);color:var(--muted);background:var(--surface-strong)}.taskPicker{width:100%;display:grid;gap:4px;text-align:left;padding:14px;cursor:pointer}.taskPicker.active{border-color:var(--green);background:#eaf8f3}.taskInstruction{margin:0;background:var(--surface-strong);border-radius:8px;padding:14px;line-height:1.7}.studentForm{display:grid;gap:16px}.feedbackBox{padding:14px;color:var(--text)}.emptyState{display:grid;justify-items:start;gap:8px;border:1px dashed var(--line);border-radius:8px;padding:16px;color:var(--muted);background:#fff}.emptyState.large{min-height:320px;align-content:center;justify-items:center;text-align:center}.emptyState svg{color:var(--green)}.emptyState strong{color:var(--text)}.emptyState p{margin:0;line-height:1.7}
...
@media (max-width:900px){.hero,.teacherGrid,.studentGrid{grid-template-columns:1fr}.heroText h1,.displayWall h1{font-size:42px}.formGrid{grid-template-columns:1fr}}@media (max-width:640px){.shell,.workspace,.displayWall{padding:16px}.topNav,.displayWall header{display:grid}.inlineForm{grid-template-columns:1fr}}
`;
